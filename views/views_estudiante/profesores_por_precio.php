...
<head>
    ...
    <title>💰 Profesores en Rango <?php echo htmlspecialchars($rangoNombre); ?> - Plataforma de Clases Online</title>
...
<body>
    ...
    <header class="modern-header">
        <div class="header-content">
            <h1 class="header-title">💰 Profesores en Rango <?php echo htmlspecialchars($rangoNombre); ?></h1>
    ...
    <main>
        ...
        <div class="alert alert-info">
            <h5>💰 Información del Rango de Precio</h5>
            <p><strong>Rango:</strong> <?php echo htmlspecialchars($rangoNombre); ?></p>
        </div>
        ...
        <?php if (empty($profesores)): ?>
            <div class="alert alert-warning text-center">
                ...
                <p>No se encontraron profesores en el rango de precio <?php echo htmlspecialchars($rangoNombre); ?> en este momento.</p>
            </div>
        <?php else: ?>
            <div class="row">
