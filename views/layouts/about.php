...
<head>
    ...
    <link rel="stylesheet" href="/plataforma-clases-online/public/css/about.css?v=<?php echo time(); ?>">
</head>
<body>
    <?php 
    ...
    <script src="/plataforma-clases-online/public/js/about.js?v=<?php echo time(); ?>"></script>
</body>
</html>