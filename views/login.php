...
<html lang="en">
  <head>
    ...
    <title>Login-Plataforma de Clases</title>
  </head>
  <body>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading text-center mb-4">Bienvenido!</h3>
              ...
              <form>
                ...
                <div class="form-floating mb-3">
                  <input type="password" class="form-control" id="password" placeholder="Ingresa tu COntrasena">
